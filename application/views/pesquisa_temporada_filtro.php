		...
		<div class="control-group">
			<div class="controls">
				<label class="radio"><small>Indiferente</small>
					<input type="radio" id="iTipoImovel" name="iTipoImovel" value="null" <?php echo set_radio('iTipoImovel', "null", TRUE); ?>>
				</label>
			</div>
		</div>		
		...
		<div class="control-group">
			<div class="controls">
				<label class="radio"><small><?php echo mb_convert_encoding($row->tpi_descricao, "ISO-8859-1", "auto"); ?></small>
					<input type="radio" id="iTipoImovel<?php echo $row->tpi_id; ?>" name="iTipoImovel" value="<?php echo $row->tpi_id; ?>" <?php echo set_radio('iTipoImovel', $row->tpi_id); ?>>
				</label>
			</div>
		</div>
		<?php }} ?>
