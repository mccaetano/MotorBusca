		...
		<div class="control-group">
			<div class="controls">
				<label class="radio"><small>Indiferente</small>
					<input type="radio" id="iContratoTipo" name="iContratoTipo" value="null" <?php echo set_radio('iContratoTipo', 'null', TRUE); ?>>
				</label>
			</div>
		</div>
		...
		<div class="control-group">
			<div class="controls">
				<label class="radio"><small><?php echo mb_convert_encoding($row->pct_descricao, "ISO-8859-1", "auto"); ?></small>
					<input type="radio" id="iContratoTipo<?php echo $row->pct_id; ?>" name="iContratoTipo" value="<?php echo $row->pct_id; ?>" <?php echo set_radio('iContratoTipo', $row->pct_id); ?>>
				</label>
			</div>
		</div>
		<?php }} ?>
	...
	<div class="well">		
		...
		<div class="control-group">
			<div class="controls">
				<label class="radio"><small>Indiferente</small>
					<input type="radio" id="iCasaTipo" name="iCasaTipo" value="null" <?php echo set_radio('iCasaTipo', "null", TRUE); ?>>
				</label>
			</div>
		</div>		
		...
		<div class="control-group">
			<div class="controls">
				<label class="radio"><small><?php echo mb_convert_encoding($row->pt_descricao, "ISO-8859-1", "auto"); ?></small>
					<input type="radio" id="iCasaTipo<?php echo $row->pt_id; ?>" name="iCasaTipo" value="<?php echo $row->pt_id; ?>" <?php echo set_radio('iCasaTipo', $row->pt_id); ?>>
				</label>
			</div>
		</div>
		<?php }} ?>
	...
	<div class="well">		
		...
		<div class="control-group">
			<div class="controls">
				<label class="radio"><small>Indiferente</small>
					<input type="radio" id="iQuartos" name="iQuartos" value="null" <?php echo set_radio('iQuartos', "null", TRUE); ?>>
				</label>
			</div>		
		</div>
		<div class="control-group">
			<div class="controls">
				<label class="radio"><small>1 Quarto</small>
					<input type="radio" id="iQuartos1" name="iQuartos" value="1" <?php echo set_radio('iQuartos', "1"); ?>>
				</label>
			</div>
		</div>
		<div class="control-group">
			<div class="controls">
				<label class="radio"><small>2 Quarto</small>
					<input type="radio" id="iQuartos2" name="iQuartos" value="2" <?php echo set_radio('iQuartos', "2"); ?>>
				</label>
			</div>
		</div>
		<div class="control-group">
			<div class="controls">
				<label class="radio"><small>3 Quarto</small>
					<input type="radio" id="iQuartos3" name="iQuartos" value="3" <?php echo set_radio('iQuartos', "3"); ?>>
				</label>
			</div>
		</div>
	</div>