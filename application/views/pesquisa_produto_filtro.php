		...
		<div class="control-group">
			<div class="controls">
				<label class="radio"><small>Indiferente</small>
					<input type="radio" id="iCategoria" name="iCategoria" value="null" <?php echo set_radio('iCategoria', 'null', TRUE); ?>>
				</label>
			</div>
		</div>
		...
		<div class="control-group">
			<div class="controls">
				<label class="radio"><small><?php echo $row->prc_descricao; ?></small>
					<input type="radio" id="iCategoria<?php echo $row->prc_id; ?>" name="iCategoria" value="<?php echo $row->prc_id; ?>" <?php echo set_radio('iCategoria', $row->prc_id); ?>>
				</label>
			</div>
		</div>
		<?php }} ?>
	...
	<div class="well">		
		...
		<div class="control-group">
			<div class="controls">
				<label class="radio"><small>Indiferente</small>
					<input type="radio" id="iMarca" name="iMarca" value="null" <?php echo set_radio('iMarca', "null", TRUE); ?>>
				</label>
			</div>
		</div>		
		...
		<div class="control-group">
			<div class="controls">
				<label class="radio"><small><?php echo $row->pmr_descricao; ?></small>
					<input type="radio" id="iMarca<?php echo $row->pmr_id; ?>" name="iMarca" value="<?php echo $row->pmr_id; ?>" <?php echo set_radio('iMarca', $row->pmr_id); ?>>
				</label>
			</div>
		</div>
		<?php }} ?>
	...
	<div class="well">		
		...
		<div class="control-group">
			<div class="controls">
				<label class="radio"><small>Indiferente</small>
					<input type="radio" id="iModelo" name="iModelo" value="null" <?php echo set_radio('iModelo', "null", TRUE); ?>>
				</label>
			</div>
		</div>		
		...
		<div class="control-group">
			<div class="controls">
				<label class="radio"><small><?php echo $row->pmd_descricao; ?></small>
					<input type="radio" id="iModelo<?php echo $row->pmd_id; ?>" name="iModelo" value="<?php echo $row->pmd_id; ?>" <?php echo set_radio('iModelo', $row->pmd_id); ?>>
				</label>
			</div>
		</div>
		<?php }} ?>
