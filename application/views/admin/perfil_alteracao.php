<div class="row-fluid">
	<div class="span8"><h1>Alterar Perfil</h1></div>
...
<div class="well">
	<form action="<?php echo base_url();?>admin/perfil/alteracao/<?php echo $perfil->id_perfil; ?>" class="form-horizontal" method="post">	
		<fieldset>
			<div class="control-group">
			    <label class="control-label" for="iNome">Nome:</label>
			    <div class="controls">
			      <input type="text" id="iNome" name="iNome" placeholder="Nome completo" value="<?php echo $perfil->nome_completo; ?>">
			    </div>
		  	</div>
		  	<div class="control-group">
		  	...
		  	<div class="control-group">
			    ...
			    <div class="controls">
			      <input type="checkbox" id="iAtivo" name="iAtivo"  <?php echo $perfil->ativo == 1 ? 'checked': ''; ?>>
			    </div>
		  	</div>
		  	<div class="control-group">
			    ...
			    <div class="controls">
			    	<select id="iAcesso" name="iAcesso">
			    		...
			    		<option value="<?php echo $perfil_acesso->pra_id; ?>" <?php echo $perfil->t_mb_perfil_acesso_pra_id == $perfil_acesso->pra_id ? 'selected': ''; ?>><?php echo $perfil_acesso->pra_descricao; ?></option>
			    		<?php }} ?>
			    	</select>
			    </div>
		  	</div>
