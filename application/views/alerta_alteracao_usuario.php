...
<hr>
<div class="well">
	<form id="frmForm" name="frmForm" action="<?php echo base_url();?>alerta/alteracao/<?php echo $alerta->alr_id; ?>/<?php echo $tipoalerta; ?>" method="post">
		<fieldset>
			<div class="row text-center">
				<div class="span12">
					<input type="text" id="iPesquisa" name="iPesquisa" class="span10"
						placeholder="Titulo do Alerta" value="<?php echo set_value('iPesquisa', $alerta->alr_pesquisa); ?>">
				</div>
			</div>
			<div class="row text-center">
								...
								<div class="control-group">
									...
									<div class="controls"> 
										<select name="iImovelTipoContrato" id="iImovelTipoContrato">
											<option value="" <?php echo  $alerta_imovel_tipo_contrato == null ? "selected" : ""; ?>>Indiferente</option>
											<?php if ($pesquisa_tipo_casa) { foreach ($pesquisa_tipo_casa as $row) {?>
											<option value="<?php echo $row->pct_id; ?>" <?php echo $alerta_imovel_tipo_contrato == $row->pct_id ? "selected" : "" ?>><?php echo $row->pct_descricao; ?></option>
											<?php }} ?>
										</select>
									</div>
								</div>
